...
from ascender.api.generics import LoggedLoginView, LoggedLogoutView
from ascender.api.views.root import (
    ApiRootView,
    ApiV2RootView,
    ApiV2PingView,
    ApiV2ConfigView,
...
from ascender.api.views.schedule import (
    SchedulePreview,
    ScheduleZoneInfo,
)
from ascender.api.views.job import (
    UnifiedJobList,
    JobCredentialsList,
)
...
from ascender.api.views.user import (
    UserMeList,
)
from ascender.api.views.oauth2 import (
    OAuth2ApplicationList,
    OAuth2TokenList,
    ApplicationOAuth2TokenList,
    OAuth2ApplicationDetail,
)
from ascender.api.views.job_template import (
    UnifiedJobTemplateList,
    JobTemplateCredentialsList,
)

from ascender.api.views.bulk import (
    BulkView,
    BulkHostCreateView,
    BulkHostDeleteView,
    BulkJobLaunchView,
...
v2_urls = [
    ...
    path('settings/', include('ascender.conf.urls')),
    ...
    path('federated_inventories/', include(federated_inventory_urls)),
...
from ascender.api.schema import schema_view, swagger_ui_view, redoc_view
...
from ascender.api.urls.debug import urls as debug_urls
