...
low-level model and vendored ascender.dab modules, so importing anything from
...
def get_current_user():
    ...
    # ascender.api.generics.APIView.initialize_request once DRF authentication has
