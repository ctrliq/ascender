...
from ascender.main.request_context import get_current_user
...
from ascender.main.models import accepts_json, UnifiedJobTemplate, UnifiedJob
from ascender.main.models.notifications import NotificationTemplate, JobNotificationMixin
from ascender.main.models.base import CreatedModifiedModel, VarsDictProperty
from ascender.main.models.rbac import ROLE_SINGLETON_SYSTEM_ADMINISTRATOR, ROLE_SINGLETON_SYSTEM_AUDITOR
from ascender.main.fields import ImplicitRoleField, JSONBlob, OrderedManyToManyField
...
# (see ascender.main.tasks.callback.build_stats_artifacts). Since every job emits
