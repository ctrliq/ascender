...
from ascender.main.models.base import CommonModelNameNotUnique, CreatedModifiedModel
from ascender.main.utils import encrypt_field, decrypt_field, set_environ
from ascender.main.notifications.email_backend import CustomEmailBackend
from ascender.main.notifications.slack_backend import SlackBackend
from ascender.main.notifications.twilio_backend import TwilioBackend
from ascender.main.notifications.pagerduty_backend import PagerDutyBackend
from ascender.main.notifications.webhook_backend import WebhookBackend
from ascender.main.notifications.mattermost_backend import MattermostBackend
from ascender.main.notifications.grafana_backend import GrafanaBackend
...
from ascender.main.notifications.matrix_backend import MatrixBackend
...
class JobNotificationMixin(object):
 ...
 'created_by': 'admin'}""",
    ...
    def build_notification_message(self, nt, status):
        ...
        from ascender.api.serializers import UnifiedJobSerializer
    ...
    def send_notification_templates(self, status):
        from ascender.main.tasks.system import send_notifications  # avoid circular import
