...
from ascender.dab.lib.utils.models import prevent_search, get_type_for_model

# Ascender
from ascender.main.models.base import CommonModelNameNotUnique, PasswordFieldsModel, NotificationFieldsModel
from ascender.main.dispatch import get_task_queuename
from ascender.main.dispatch.control import Control as ControlDispatcher
from ascender.main.registrar import activity_stream_registrar
from ascender.main.models.mixins import ResourceMixin, TaskManagerUnifiedJobMixin, ExecutionEnvironmentMixin
...
from ascender.main.utils.encryption import encrypt_dict, decrypt_field
from ascender.main.utils import polymorphic
from ascender.main.constants import ACTIVE_STATES, CAN_CANCEL, JOB_VARIABLE_PREFIXES
from ascender.main.redact import UriCleaner, REPLACE_STR
from ascender.main.consumers import emit_channel_notification
from ascender.main.fields import AskForField, OrderedManyToManyField
...
class UnifiedJobTemplate(PolymorphicModel, CommonModelNameNotUnique, ExecutionEnvironmentMixin, NotificationFieldsModel):
    ...
    def notification_templates(self):
        ...
        from ascender.main.models.notifications import NotificationTemplate
    ...
    def create_unified_job(self, instance_groups=None, **kwargs):
        ...
        from ascender.main.signals import disable_activity_stream, activity_stream_create
...
class UnifiedJob(
    ...
    def result_stdout_raw_handle(self, enforce_max_bytes=True):
        ...
        if enforce_max_bytes:
            ...
            from ascender.main.tasks.system import purge_old_stdout_files  # circular import
    ...
    def signal_start(self, **kwargs):
        ...
        # from ascender.main.tasks import notify_task_runner
    ...
    def control_plane_instance_group(self):
        from ascender.main.models.ha import InstanceGroup
