...
from ascender.main.utils.common import get_corrected_cpu, get_cpu_effective_capacity, get_corrected_memory, get_mem_effective_capacity
from ascender.main.models.mixins import RelatedJobsMixin, ResourceMixin
from ascender.main.models.receptor_address import ReceptorAddress
...
def schedule_policy_task():
    from ascender.main.tasks.system import apply_cluster_membership_policies
...
def schedule_write_receptor_config(broadcast=True):
    from ascender.main.tasks.receptor import write_receptor_config  # prevents circular import
...
def on_instance_saved(sender, instance, created=False, raw=False, **kwargs):
    ...
    if settings.IS_K8S and instance.node_type in [Instance.Types.HOP, Instance.Types.EXECUTION]:
        if instance.node_state == Instance.States.DEPROVISIONING:
            from ascender.main.tasks.receptor import remove_deprovisioned_node  # prevents circular import
