...
from ascender.main.models.base import PROJECT_UPDATE_JOB_TYPE_CHOICES, PERM_INVENTORY_DEPLOY
from ascender.main.models.events import ProjectUpdateEvent, UnpartitionedProjectUpdateEvent
from ascender.main.models.notifications import (
    NotificationTemplate,
    JobNotificationMixin,
)
from ascender.main.models.unified_jobs import (
    UnifiedJob,
    UnifiedJobTemplate,
)
from ascender.main.models.jobs import Job
from ascender.main.models.mixins import ResourceMixin, TaskManagerProjectUpdateMixin, RelatedJobsMixin, WebhookKeyTemplateMixin
from ascender.main.utils import update_scm_url, polymorphic
from ascender.main.utils.ansible import skip_directory, could_be_inventory, could_be_playbook
from ascender.main.utils.execution_environments import get_control_plane_execution_environment
...
class ProjectOptions(models.Model):
    ...
    def playbooks(self):
        ...
        if project_path:
            for dirpath, dirnames, filenames in os.walk(smart_str(project_path), followlinks=settings.ASCENDER_SHOW_PLAYBOOK_LINKS):
    ...
    def delete(self, *args, **kwargs):
        ...
        for path_to_delete in paths_to_delete:
            if self.scm_type and path_to_delete:  # non-manual, concrete path
                from ascender.main.tasks.system import delete_project_files
...
class ProjectUpdate(UnifiedJob, ProjectOptions, JobNotificationMixin, TaskManagerProjectUpdateMixin):
    ...
    def _get_task_class(cls):
        from ascender.main.tasks.jobs import RunProjectUpdate
