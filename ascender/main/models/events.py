...
from ascender.main.fields import JSONBlob
from ascender.main.managers import DeferJobCreatedManager
from ascender.main.constants import MINIMAL_EVENTS
from ascender.main.models.base import CreatedModifiedModel
from ascender.main.utils import ignore_inventory_computed_fields, camelcase_to_underscore
...
class JobEvent(BasePlaybookEvent):
    ...
    def _update_host_summary_from_stats(self, hostnames):
        with ignore_inventory_computed_fields():
            ...
            from ascender.main.models import Host, JobHostSummary  # circular import
    ...
    def _update_host_metrics(updated_hosts_list):
        from ascender.main.models import HostMetric  # circular import
