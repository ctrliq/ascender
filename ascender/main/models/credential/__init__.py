...
from ascender.main.models.base import CommonModelNameNotUnique, PasswordFieldsModel, PrimordialModel
...
class CredentialType(CommonModelNameNotUnique):
    ...
    def inject_credential(self, credential, env, safe_env, args, private_data_dir):
        ...
        :param credential:       a :class:`ascender.main.models.Credential` instance
