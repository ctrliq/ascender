...
import ascender
from ascender.main.utils import memoize
...
class RecordedQueryLog(object):
    def __init__(self, log, db, dest='/var/log/ascender/profile'):
        self.log = log
        self.db = db
        self.dest = dest
        try:
    ...
    def write(self, query):
        ...
        if seconds >= self.threshold:
            ...
            for match in ('uvicorn', 'dispatcher', 'callback_receiver', 'wsrelay'):
            ...
            # ascender.__version__ is resolved once at import time and already falls
