...
from ascender.main.constants import CENSOR_VALUE
from ascender.main.utils import model_instance_diff, model_to_dict, camelcase_to_underscore, get_current_apps
from ascender.main.utils import ignore_inventory_computed_fields, ignore_inventory_group_removal, _inventory_updates
from ascender.main.tasks.system import update_inventory_computed_fields, handle_removed_image
from ascender.main.fields import (
    is_implicit_parent,
    update_role_parentage_for_instance,
)

from ascender.main import consumers

from ascender.conf.utils import conf_to_dict
...
def model_serializer_mapping():
    ...
    from ascender.conf.serializers import SettingSerializer
...
def emit_activity_stream_change(instance):
    if 'migrate' in sys.argv:
        ...
        return
    from ascender.api.serializers import ActivityStreamSerializer
