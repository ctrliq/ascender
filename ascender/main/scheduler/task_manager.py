...
# Ascender
from ascender.main.dispatch.reaper import reap_job
...
from ascender.main.utils.common import task_manager_bulk_reschedule, is_testing
...
class TaskManager(TaskBase):
    ...
    def process_tasks(self):
        ...
        if self.pre_start_failed:
            from ascender.main.tasks.system import handle_failure_notifications
