    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', ascender.main.fields.JSONBlob(default=dict, blank=True)),
            ],
            options={
                'ordering': ('pk',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_configuration', ascender.main.fields.JSONBlob(default=dict)),
                (
                    'created_by',
                    models.ForeignKey(
        ...
        migrations.AddField(
            model_name='credential',
            name='admin_role',
            field=ascender.main.fields.ImplicitRoleField(related_name='+', parent_role=['singleton:system_administrator'], to='main.Role', null='True'),
        ),
        migrations.AddField(
            model_name='credential',
            name='use_role',
            field=ascender.main.fields.ImplicitRoleField(related_name='+', parent_role=['admin_role'], to='main.Role', null='True'),
        ),
        migrations.AddField(
            model_name='credential',
            name='read_role',
            field=ascender.main.fields.ImplicitRoleField(
        ...
        migrations.AddField(
            model_name='custominventoryscript',
            name='admin_role',
            field=ascender.main.fields.ImplicitRoleField(related_name='+', parent_role='organization.admin_role', to='main.Role', null='True'),
        ),
        migrations.AddField(
            model_name='custominventoryscript',
            name='read_role',
        ...
        migrations.AddField(
            model_name='inventory',
            name='use_role',
            field=ascender.main.fields.ImplicitRoleField(related_name='+', parent_role='adhoc_role', to='main.Role', null='True'),
        ),
        migrations.AddField(
            model_name='inventory',
            name='read_role',
        ...
        migrations.AddField(
            model_name='organization',
            name='auditor_role',
            field=ascender.main.fields.ImplicitRoleField(related_name='+', parent_role='singleton:system_auditor', to='main.Role', null='True'),
        ),
        migrations.AddField(
            model_name='organization',
            name='member_role',
        ...
        migrations.AddField(
            model_name='organization',
            name='read_role',
            field=ascender.main.fields.ImplicitRoleField(related_name='+', parent_role=['member_role', 'auditor_role'], to='main.Role', null='True'),
        ),
        migrations.AddField(
            model_name='project',
            name='admin_role',
        ...
        migrations.AddField(
            model_name='team',
            name='member_role',
            field=ascender.main.fields.ImplicitRoleField(related_name='+', parent_role=None, to='main.Role', null='True'),
        ),
        migrations.AddField(
            model_name='team',
            name='read_role',
