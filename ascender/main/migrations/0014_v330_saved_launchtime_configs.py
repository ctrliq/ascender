...
from ascender.main.migrations._multi_cred import migrate_workflow_cred, migrate_workflow_cred_reverse
from ascender.main.migrations._scan_jobs import remove_scan_type_nodes
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_data', ascender.main.fields.JSONBlob(blank=True, default=dict)),
                ('survey_passwords', ascender.main.fields.JSONBlob(blank=True, default=dict, editable=False)),
                ('char_prompts', ascender.main.fields.JSONBlob(blank=True, default=dict)),
        ...
        migrations.AddField(
            ...
            field=ascender.main.fields.AskForField(blank=True, default=False),
        ),
