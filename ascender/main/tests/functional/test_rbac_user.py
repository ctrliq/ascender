...
from ascender.main.access import UserAccess, RoleAccess, TeamAccess
from ascender.main.models import User, Organization, Inventory, Role
...
def test_manage_org_auth_setting(ext_auth, superuser, expect, organization, rando, user, team):
    ...
    with mock.patch('ascender.main.access.settings') as settings_mock:
