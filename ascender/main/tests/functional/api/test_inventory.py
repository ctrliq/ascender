...
from ascender.main.models import InventorySource, Inventory, ActivityStream, Host, Job
...
def test_inventory_source_vars_prohibition(post, inventory, admin_user):
    with mock.patch('ascender.api.serializers.inventory.settings') as mock_settings:
