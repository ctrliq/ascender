...
class TestPeers:
    ...
    def test_write_receptor_config_called(self):
        ...
        """
        with mock.patch('ascender.main.models.ha.schedule_write_receptor_config') as write_method:
    ...
    def test_write_receptor_config_data(self):
        ...
        """
        from ascender.main.tasks.receptor import RECEPTOR_CONFIG_STARTER

        with mock.patch('ascender.main.tasks.receptor.read_receptor_config', return_value=list(RECEPTOR_CONFIG_STARTER)):
            from ascender.main.tasks.receptor import generate_config_data
