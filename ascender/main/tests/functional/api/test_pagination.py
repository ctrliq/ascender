...
from ascender.main.models.inventory import Group, Host
from ascender.main.models.ad_hoc_commands import AdHocCommand
from ascender.api.pagination import Pagination
...
def test_pagination_cap_page_size(get, admin, inventory):
    ...
    with patch('ascender.api.pagination.Pagination.max_page_size', 5):
