...
from ascender.api.serializers import JobLaunchSerializer
from ascender.main.models import Credential, Inventory, Host, ExecutionEnvironment, Label, InstanceGroup
from ascender.main.models.jobs import Job, JobTemplate, UnifiedJobTemplate
...
def test_job_ignore_unprompted_vars(runtime_data, job_template_prompts, post, admin_user, mocker):
    ...
    mocker.patch('ascender.api.serializers.JobSerializer.to_representation')
...
def test_callback_accept_prompted_extra_var(mocker, survey_spec_factory, job_template_prompts, post, admin_user, host):
    ...
    mocker.patch('ascender.api.serializers.JobSerializer.to_representation', return_value={})
    mocker.patch('ascender.api.views.job_template.JobTemplateCallback.find_matching_hosts', return_value=[host])
    post(
