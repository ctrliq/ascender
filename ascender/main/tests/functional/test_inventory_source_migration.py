...
from ascender.main.migrations import _inventory_source as invsrc

from django.apps import apps

from ascender.main.models import InventorySource, InventoryUpdate, ManagedCredentialType, CredentialType, Credential
