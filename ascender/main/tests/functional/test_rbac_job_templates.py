...
class TestJobTemplateSchedules:
    ...
    def test_prompts_access_checked(self, job_template, inventory, credential, rando):
        ...
        with mock.patch('ascender.main.access.JobLaunchConfigAccess.can_add') as mock_add:
        ...
        with mock.patch('ascender.main.access.JobLaunchConfigAccess.can_change') as mock_change:
