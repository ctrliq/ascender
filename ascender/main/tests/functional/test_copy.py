...
from ascender.main.models.workflow import WorkflowJobTemplate, WorkflowJobTemplateNode, WorkflowJobTemplateNodeConditionLink, WorkflowApprovalTemplate
from ascender.main.models.jobs import JobTemplate
from ascender.main.tasks.system import deep_copy_model_obj
from ascender.main.models import Label, ExecutionEnvironment, InstanceGroup
...
def test_inventory_copy(inventory, group_factory, post, get, alice, organization):
    ...
    with mock.patch('ascender.api.generics.trigger_delayed_deep_copy') as deep_copy_mock:
