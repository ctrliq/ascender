...
class TestJobLifeCycle:
    def run_tm(self, tm, expect_channel=None, expect_schedule=None, expect_commit=None):
        ...
        """
        with mock.patch('ascender.main.models.unified_jobs.UnifiedJob.websocket_emit_status') as mock_channel:
            with mock.patch('ascender.main.utils.common.ScheduleManager._schedule') as tm_sch:
