...
from ascender.main.scheduler import TaskManager, DependencyManager
from ascender.main.models import InstanceGroup
...
def test_multi_group_basic_job_launch(instance_factory, controlplane_instance_group, mocker, instance_group_factory, job_template_factory):
    ...
    with mock.patch('ascender.main.models.Job.task_impact', new_callable=mock.PropertyMock) as mock_task_impact:
        mock_task_impact.return_value = 500
        mocker.patch("ascender.main.scheduler.TaskManager.start_task")
...
def test_multi_group_with_shared_dependency(instance_factory, controlplane_instance_group, mocker, instance_group_factory, job_template_factory):
    ...
    pu.save()
    with mock.patch("ascender.main.scheduler.TaskManager.start_task"):
        DependencyManager().schedule()
        TaskManager().schedule()
