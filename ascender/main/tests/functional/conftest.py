...
# Ascender
from ascender.main.models.projects import Project
...
from ascender.main.models.credential import CredentialType, Credential
from ascender.main.models.jobs import JobTemplate, SystemJobTemplate
from ascender.main.models.inventory import Group, Inventory, InventoryUpdate, InventorySource
from ascender.main.models.organization import (
    Organization,
    Team,
)
from ascender.main.models.rbac import Role
from ascender.main.models.notifications import NotificationTemplate, Notification
from ascender.main.models.workflow import WorkflowJobTemplate
from ascender.main.models.ad_hoc_commands import AdHocCommand
from ascender.main.models.oauth import OAuth2Application as Application
...
dab_rr_initial = importlib.import_module('ascender.dab.resource_registry.migrations.0001_initial')
...
def run_computed_fields_right_away(request):
    ...
    mocked = mock.patch('ascender.main.signals.update_inventory_computed_fields.delay', new=run_me)
    mocked.start()
...
def credentialtype_external():
    ...
    with mock.patch('ascender.main.models.credential.CredentialType.plugin', new_callable=PropertyMock) as mock_plugin:
...
def scm_inventory_source(inventory, project):
    ...
    with mock.patch('ascender.main.models.unified_jobs.UnifiedJobTemplate.update'):
        inv_src.save()
    return inv_src
...
def disable_database_settings(mocker):
    m = mocker.patch('ascender.conf.settings.SettingsWrapper.all_supported_settings', new_callable=PropertyMock)
    m.return_value = []
