...
from ascender.dab.jwt_consumer.awx.auth import AwxJWTAuthentication
from ascender.dab.jwt_consumer.common.auth import JWTCommonAuth
from ascender.dab.jwt_consumer.common.exceptions import InvalidTokenException
from ascender.dab.resource_registry.models import Resource

# Coverage for the vendored ascender.dab.jwt_consumer auth path (formerly covered
