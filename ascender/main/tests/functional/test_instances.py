...
from ascender.main.models import AdHocCommand, InventoryUpdate, JobTemplate, Job
from ascender.main.models.activity_stream import ActivityStream
from ascender.main.models.ha import Instance, InstanceGroup
...
class TestPolicyTaskScheduling:
    ...
    def test_policy_task_ran_for_ig_when_needed(self, instance_group_factory, field, value, expect):
        ...
        with mock.patch('ascender.main.models.ha.schedule_policy_task') as mock_policy:
