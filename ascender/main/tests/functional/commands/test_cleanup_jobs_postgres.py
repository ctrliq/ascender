...
from ascender.main.management.commands.cleanup_jobs import Command
from ascender.main.models import Job, Host, JobHostSummary
...
def test_pre_delete_job_host_summaries_spans_chunks(inventory):
    ...
    with mock.patch('ascender.main.management.commands.cleanup_jobs.JHS_CHUNK_SIZE', 2):
        skipped, deleted = _command().cleanup_jobs()
