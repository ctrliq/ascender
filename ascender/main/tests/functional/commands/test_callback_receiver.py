...
from ascender.main.dispatch.worker.callback import job_stats_wrapup, CallbackBrokerWorker

from ascender.main.models.jobs import Job
from ascender.main.models.inventory import InventoryUpdate, InventorySource
from ascender.main.models.events import InventoryUpdateEvent
...
def test_wrapup_does_not_send_notifications(mocker):
    ...
    mock = mocker.patch('ascender.main.models.notifications.JobNotificationMixin.send_notification_templates')
...
class TestCallbackBrokerWorker(TransactionTestCase):
    ...
    def turn_off_websockets(self):
        with mock.patch('ascender.main.dispatch.worker.callback.emit_event_detail', lambda *a, **kw: None):
            yield
