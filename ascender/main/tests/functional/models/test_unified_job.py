...
# Ascender
from ascender.main.models import UnifiedJobTemplate, Job, JobTemplate, WorkflowJobTemplate, WorkflowApprovalTemplate, Project, WorkflowJob, Schedule, Credential
...
class TestCreateUnifiedJob:
    ...
    def test_many_to_many(self, mocker, job_template_labels):
        ...
        _get_unified_job_field_names = mocker.patch('ascender.main.models.jobs.JobTemplate._get_unified_job_field_names', return_value=['labels'])
