...
from ascender.main.models import JobTemplate, Schedule, ActivityStream
...
class TestComputedFields:
    ...
    def test_computed_fields_time_change(self, job_template):
        ...
        with self.assert_no_unwanted_stuff(s):
            ...
            with mock.patch('ascender.main.models.schedules.emit_channel_notification'):
                s.update_computed_fields()
...
@pytest.mark.django_db
@mock.patch('ascender.main.models.schedules.now', lambda: datetime(2030, 3, 5, tzinfo=dt_timezone.utc))
