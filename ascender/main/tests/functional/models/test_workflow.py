...
# Ascender
from ascender.main.models import workflow as workflow_models
from ascender.main.models.workflow import (
    WorkflowApproval,
...
from ascender.main.models.projects import ProjectUpdate
from ascender.main.models.credential import Credential, CredentialType
from ascender.main.models.label import Label
...
from ascender.api.views.workflow import WorkflowJobTemplateNodeSuccessNodesList
...
class TestWorkflowJobTemplatePrompts:
    ...
    def test_set_all_the_prompts(self, post, organization, inventory, org_admin):
        ...
        with mock.patch('ascender.main.queue.CallbackQueueDispatcher.dispatch', lambda self, obj: None):
