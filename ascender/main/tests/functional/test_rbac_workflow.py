...
from ascender.main.models import JobTemplate, WorkflowJobTemplateNode

from rest_framework.exceptions import PermissionDenied

from ascender.main.models import InventorySource, JobLaunchConfig
...
class TestWorkflowJobTemplateNodeAccess:
    ...
    def test_attacher_permissions(self, wfjt_node, job_template, rando, add_wfjt_admin, permission_type, add_jt_admin, expected_result, mocker, method_type):
        ...
        from ascender.main.models import Credential, Label, InstanceGroup, Organization, CredentialType
