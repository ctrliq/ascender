...
from ascender.main.tasks.system import cluster_node_heartbeat
...
@pytest.mark.django_db
@mock.patch('ascender.main.tasks.system.inspect_execution_and_hop_nodes', lambda *args, **kwargs: None)
@mock.patch('ascender.main.models.ha.get_cpu_effective_capacity', lambda cpu, is_control_node: 8)
@mock.patch('ascender.main.models.ha.get_mem_effective_capacity', lambda mem, is_control_node: 62)
...
@pytest.mark.django_db
@mock.patch('ascender.main.models.ha.get_cpu_effective_capacity', lambda cpu: 8)
@mock.patch('ascender.main.models.ha.get_mem_effective_capacity', lambda mem: 62)
...
class TestAnsibleFactsSave:
    ...
    def test_update_hosts_forever_deadlock(self, inventory, mocker):
        ...
        for host in hosts:
            host.ansible_facts = {'foo': 'bar'}
        db_mock = mocker.patch('ascender.main.tasks.facts.Host.objects.bulk_update')
