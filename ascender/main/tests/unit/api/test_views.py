...
from ascender.api.views.root import ApiVersionRootView
from ascender.api.views.inventory import (
...
from ascender.main.views import handle_error
...
class TestJobTemplateLabelList:
    def test_inherited_mixin_unattach(self):
        with mock.patch('ascender.api.views.labels.LabelSubListCreateAttachDetachView.unattach') as mixin_unattach:
...
class TestInventoryInventorySourcesUpdate:
    ...
    def test_post(self, mocker, can_update, can_access, is_source, expected):
        ...
        serializer_class = mocker.patch('ascender.api.serializers.InventoryUpdateDetailSerializer')
