...
from ascender.api.pagination import ActivityStreamPaginator, ActivityStreamPagination, DisabledPaginator, UnifiedJobPaginator, UnifiedJobPagination


class TestUnifiedJobPaginator:
    def test_count_uses_rbac_unfiltered_count_excluding_workflow_approvals(self):
        with patch('ascender.api.pagination.UnifiedJob') as mock_uj:
...
class TestActivityStreamPaginator:
    def test_count_uses_unfiltered_table_count(self):
        with patch('ascender.api.pagination.ActivityStream') as mock_as:
