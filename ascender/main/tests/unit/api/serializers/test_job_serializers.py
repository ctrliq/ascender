...
# Ascender
from ascender.api.serializers import JobSerializer, JobOptionsSerializer
...
@mock.patch('ascender.api.serializers.BaseSerializer.to_representation', lambda self, obj: {'extra_vars': obj.extra_vars})
...
@mock.patch('ascender.api.serializers.BaseSerializer.get_summary_fields', lambda x, y: {})
