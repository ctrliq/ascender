...
from ascender.main.models import Job, WorkflowJobTemplateNode, WorkflowJob, WorkflowJobNode, WorkflowJobTemplate, Project, Inventory, JobTemplate
...
@mock.patch('ascender.api.serializers.BaseSerializer.get_related', lambda x, y: {})
...
@pytest.mark.django_db
@mock.patch('ascender.api.serializers.BaseSerializer.validate', lambda self, attrs: attrs)
class TestWorkflowJobTemplateNodeSerializerSurveyPasswords:
    ...
    def test_use_db_answer(self, jt, mocker):
        ...
        mocker.patch('ascender.main.models.mixins.decrypt_value', return_value='foo')
...
@mock.patch('ascender.api.serializers.WorkflowJobTemplateNodeSerializer.get_related', lambda x, y: {})
