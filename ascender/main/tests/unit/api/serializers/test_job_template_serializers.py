...
@mock.patch('ascender.api.serializers.JobOptionsSerializer.get_related', lambda x, y: {})
...
class TestJobTemplateSerializerGetSummaryFields:
    ...
    def test_copy_edit_standard(self, mocker, job_template_factory):
        ...
        mocker.patch("ascender.api.serializers.base.role_summary_fields_generator", return_value='Can eat pie')
        mocker.patch("ascender.main.access.JobTemplateAccess.can_change", return_value='foobar')
        mocker.patch("ascender.main.access.JobTemplateAccess.can_copy", return_value='foo')
