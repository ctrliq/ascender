...
import ascender.main.notifications.pagerduty_backend as pagerduty_backend
...
def test_send_messages_triggers_one_incident_per_message():
    with mock.patch('ascender.main.notifications.pagerduty_backend.requests.post') as post_mock:
