...
import ascender.main.notifications.slack_backend as slack_backend


def test_send_messages():
    with mock.patch('ascender.main.notifications.slack_backend.WebClient') as slack_sdk_mock:
...
def test_send_messages_fail():
    with mock.patch('ascender.main.notifications.slack_backend.WebClient') as slack_sdk_mock, pytest.raises(RuntimeError, match=r'.*not_in_channel.*'):
        WebClient_mock = slack_sdk_mock.return_value
