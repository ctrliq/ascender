...
import ascender.main.notifications.twilio_backend as twilio_backend
...
def test_send_messages():
    with mock.patch('ascender.main.notifications.twilio_backend.requests.post') as post_mock:
