...
from ascender.main.models.jobs import JobTemplate, Job
from ascender.main.models import Inventory, CredentialType, Credential, Project
from ascender.main.models.workflow import WorkflowJobTemplate, WorkflowJobTemplateNode, WorkflowJob, WorkflowJobNode, WorkflowApproval, merge_stats_artifacts
...
class TestWorkflowJobInheritNodesMixin:
    class TestCreateWorkflowJobNodes:
        ...
        def test__create_workflow_job_nodes(self, mocker, job_template_nodes):
            workflow_job_node_create = mocker.patch('ascender.main.models.WorkflowJobTemplateNode.create_workflow_job_node')
    ...
    class TestMapWorkflowJobNodes:
        ...
        def test__map_workflow_job_nodes(self, job_template_nodes, job_nodes, mocker):
            ...
            mocker.patch('ascender.main.models.workflow.WorkflowJobTemplateNode.create_workflow_job_node', return_value=wj_node)
...
class TestWorkflowJobCreate:
    def test_create_no_prompts(self, wfjt_node_no_prompts, workflow_job_unit, mocker):
        ...
        mocker.patch('ascender.main.models.WorkflowJobNode.objects.create', mock_create)
...
@pytest.mark.django_db
@mock.patch('ascender.main.models.workflow.WorkflowNodeBase.get_parent_nodes', lambda self: [])
