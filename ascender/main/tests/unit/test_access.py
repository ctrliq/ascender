...
class TestWorkflowAccessMethods:
    ...
    def test_workflow_can_add(self, workflow, user_unit):
        ...
        with mock.patch('ascender.main.models.rbac.Role.__contains__', return_value=True):
            with mock.patch('ascender.main.access.get_object_or_400', mock_get_object):
...
def test_consumer_access_covers_all_event_groups():
    ...
    There are two producers of such groups:
      - emit_event_detail in ascender.main.models.events, which derives the name from
    ...
    """
    from ascender.main.access import consumer_access
    from ascender.main.models.events import AdHocCommandEvent, InventoryUpdateEvent, JobEvent, ProjectUpdateEvent, SystemJobEvent
