...
from ascender.main.utils import common
...
def memoized_function(mocker, mock_cache):
    with mock.patch('ascender.main.utils.common.get_memoize_cache', return_value=mock_cache):
...
def test_memoize_delete(memoized_function, mock_cache):
    ...
    with mock.patch('ascender.main.utils.common.memoize_delete', side_effect=mock_cache.delete):
