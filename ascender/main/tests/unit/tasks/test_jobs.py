...
from ascender.main.tasks import jobs
...
@mock.patch('ascender.main.tasks.facts.finish_fact_cache')
@mock.patch('ascender.main.tasks.facts.settings')
@mock.patch('ascender.main.tasks.jobs.create_partition', return_value=True)
