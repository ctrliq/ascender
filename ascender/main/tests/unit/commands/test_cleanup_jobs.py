...
from ascender.main.management.commands.cleanup_jobs import DeleteMeta, _pre_delete_job_host_summaries, JHS_CHUNK_SIZE
from ascender.main.models import Job


class TestPreDeleteJobHostSummaries:
    def test_empty_list_is_noop(self):
        with mock.patch('ascender.main.management.commands.cleanup_jobs.connection') as mock_conn:
...
class TestDeleteMetaPreDelete:
    ...
    @mock.patch('ascender.main.management.commands.cleanup_jobs._pre_delete_job_host_summaries')
    def test_called_for_job_class(self, mock_pre_delete):
        from ascender.main.management.commands.cleanup_jobs import DeleteMeta
        from ascender.main.models import Job
    ...
    def test_skipped_for_non_job_class(self, mock_pre_delete):
        from ascender.main.management.commands.cleanup_jobs import DeleteMeta
        from ascender.main.models import ProjectUpdate
...
class TestFindPartitionsToDrop:
    ...
    def test_partitions_are_collected(self):
        ...
        with mock.patch('ascender.main.management.commands.cleanup_jobs.connection', connection):
