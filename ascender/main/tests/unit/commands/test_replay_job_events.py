...
from ascender.main.management.commands.replay_job_events import (
    ReplayJobEvents,
)
...
class TestReplayJobEvents:
    ...
    @mock.patch('ascender.main.management.commands.replay_job_events.emit_event_detail', lambda *a, **kw: None)
