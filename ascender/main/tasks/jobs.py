...
from ascender.main.constants import (
...
from ascender.main.tasks.signals import with_signal_handling, signal_callback
from ascender.main.tasks.receptor import AWXReceptorJob
from ascender.main.tasks.facts import start_fact_cache, finish_fact_cache
from ascender.main.exceptions import AwxTaskError, PostRunError, ReceptorNodeNotFound
from ascender.main.utils.ansible import read_ansible_config
from ascender.main.utils.execution_environments import CONTAINER_ROOT, to_container_path
from ascender.main.utils.safe_yaml import safe_dump, sanitize_jinja
...
class BaseTask(object):
    ...
    def build_private_data_files(self, instance, private_data_dir):
        ...
        {
            'credentials': {
                <ascender.main.models.Credential>: '/path/to/decrypted/data',
                <ascender.main.models.Credential>: '/path/to/decrypted/data',
                ...
            },
            'certificates': {
                <ascender.main.models.Credential>: /path/to/signed/ssh/certificate,
                <ascender.main.models.Credential>: /path/to/signed/ssh/certificate,
                ...
            }
        }
...
class RunJob(SourceControlMixin, BaseTask):
    ...
    def build_private_data(self, job, private_data_dir):
        ...
        {
            'credentials': {
                <ascender.main.models.Credential>: <credential_decrypted_ssh_key_data>,
                <ascender.main.models.Credential>: <credential_decrypted_ssh_key_data>,
                ...
            },
            'certificates': {
                <ascender.main.models.Credential>: <signed SSH certificate data>,
                <ascender.main.models.Credential>: <signed SSH certificate data>,
                ...
            }
        }
...
class RunInventoryUpdate(SourceControlMixin, BaseTask):
    ...
    def post_run_hook(self, inventory_update, status):
        ...
        from ascender.main.management.commands.inventory_import import Command as InventoryImportCommand
