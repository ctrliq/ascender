...
import type { HostSearchParams } from './HostFilterUtils';
...
describe('toQueryString', () => {
  test('should return an empty string', () => {
    expect(toQueryString(QS_CONFIG as unknown as QSConfig, undefined)).toEqual(
      ''
    );
  });
  test('should return namespaced query string with a single key-value pair', () => {
    ...
    expect(toQueryString(QS_CONFIG as unknown as QSConfig, object)).toEqual(
      'mock.foo=bar'
    );
  });
...
describe('removeNamespacedKeys', () => {
  test('should return an empty object', () => {
    expect(
      removeNamespacedKeys(QS_CONFIG as unknown as QSConfig, undefined)
    ).toEqual({});
  });
  test('should remove namespace from keys', () => {
    expect(
      removeNamespacedKeys(QS_CONFIG as unknown as QSConfig, {
        'mock.foo': 'bar',
      })
    ).toEqual({
      foo: 'bar',
...
describe('removeDefaultParams', () => {
  test('should return an empty object', () => {
    expect(
      removeDefaultParams(QS_CONFIG as unknown as QSConfig, undefined)
    ).toEqual({});
  });
  test('should remove default params', () => {
    ...
    expect(
      removeDefaultParams(
        QS_CONFIG as unknown as QSConfig,
        object as unknown as HostSearchParams
      )
    ).toEqual({
      foo: ['bar', 'baz', 'qux'],
      apat: 'lima',
