...
def _backfill_missing_resources(registry, resource_cls, resource_type_cls, apps):
    ...
    from ascender.dab.resource_registry.models import init_resource_from_object
...
def connect_resource_signals(sender, **kwargs):
    from ascender.dab.resource_registry.signals import handlers
...
class ResourceRegistryConfig(AppConfig):
    ...
    name = "ascender.dab.resource_registry"
    ...
    def ready(self):
        ...
        if apps.is_installed("ascender.dab.rbac"):
            from ascender.dab.rbac.models import RoleTeamAssignment, RoleUserAssignment
            from ascender.dab.resource_registry.fields import AssignmentResourceField
