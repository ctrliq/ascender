...
from ascender.dab.lib.utils.response import CSVStreamResponse, get_relative_url
from ascender.dab.lib.utils.schema import extend_schema_if_available
from ascender.dab.lib.utils.settings import get_setting
from ascender.dab.lib.utils.views.django_app_api import AnsibleBaseDjangoAppApiView
from ascender.dab.lib.utils.views.permissions import try_add_oauth2_scope_permission
from ascender.dab.resource_registry.constants import SHARED_USER_RESOURCE_TYPE
from ascender.dab.resource_registry.models import Resource, ResourceType, service_id
from ascender.dab.resource_registry.registry import get_registry
from ascender.dab.resource_registry.serializers import BulkResourceUpdateItemSerializer, ResourceListSerializer, ResourceSerializer, ResourceTypeSerializer
from ascender.dab.rest_filters.rest_framework.field_lookup_backend import FieldLookupBackend
from ascender.dab.rest_filters.rest_framework.order_backend import OrderByBackend
from ascender.dab.rest_filters.rest_framework.type_filter_backend import TypeFilterBackend
...
class ServiceIndexRootView(AnsibleBaseDjangoAppApiView):
    ...
    def get(self, request, format=None):
        ...
        if 'ascender.dab.rbac' in settings.INSTALLED_APPS:
            try:
