...
import jwt
from ascender.main.request_context import impersonate  # Ascender: in-tree replacement for django-crum
...
from ascender.dab.jwt_consumer.common.cert import JWTCert, JWTCertException
from ascender.dab.jwt_consumer.common.exceptions import HTTP_498_INVALID_TOKEN, InvalidTokenException
from ascender.dab.lib.logging.runtime import log_excess_runtime
from ascender.dab.lib.utils.apps import is_rbac_installed
from ascender.dab.lib.utils.auth import get_user_by_ansible_id
from ascender.dab.lib.utils.translations import translatableConditionally as _
...
class JWTCommonAuth:
    ...
    def process_rbac_permissions(self):
        ...
        if rbac_installed:
            from ascender.dab.rbac.claims import get_claims_hash, get_user_claims, get_user_claims_hashable_form, save_user_claims
