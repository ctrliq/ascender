...
def get_from_import(module_name, attr):
    ...
    .. deprecated::
        ...
        Use :func:`ascender.dab.lib.utils.imports.import_object` directly instead.
    ...
    """
    warnings.warn(
        "get_from_import is deprecated. Use ascender.dab.lib.utils.imports.import_object directly.",
        DeprecationWarning,
        stacklevel=2,
    )
