...
from ascender.conf.settings import SettingsWrapper
...
def test_simple_setting_registration(reg):
    ...
    assert reg.get_registered_settings() == ['ASCENDER_SOME_SETTING_ENABLED']
...
def test_simple_setting_unregistration(reg):
    ...
    reg.unregister('ASCENDER_SOME_SETTING_ENABLED')
    assert reg.get_registered_settings() == []
...
def test_field_class_required_for_registration(reg):
    ...
    with pytest.raises(ImproperlyConfigured):
        reg.register('ASCENDER_SOME_SETTING_ENABLED')


def test_get_registered_settings_by_slug(reg):
    reg.register('ASCENDER_SOME_SETTING_ENABLED', field_class=fields.BooleanField, category=_('System'), category_slug='system')
    assert reg.get_registered_settings(category_slug='system') == ['ASCENDER_SOME_SETTING_ENABLED']
    assert reg.get_registered_settings(category_slug='other') == []


def test_get_registered_read_only_settings(reg):
    reg.register('ASCENDER_SOME_SETTING_ENABLED', field_class=fields.BooleanField, category=_('System'), category_slug='system')
    reg.register('ASCENDER_SOME_READ_ONLY', field_class=fields.BooleanField, category=_('System'), category_slug='system', read_only=True)
    assert reg.get_registered_settings(read_only=True) == ['ASCENDER_SOME_READ_ONLY']
    assert reg.get_registered_settings(read_only=False) == ['ASCENDER_SOME_SETTING_ENABLED']
    assert reg.get_registered_settings() == ['ASCENDER_SOME_SETTING_ENABLED', 'ASCENDER_SOME_READ_ONLY']
...
def test_get_registered_categories(reg):
    reg.register('ASCENDER_SOME_SETTING_ENABLED', field_class=fields.BooleanField, category=_('System'), category_slug='system')
    reg.register('ASCENDER_SOME_OTHER_SETTING_ENABLED', field_class=fields.BooleanField, category=_('OtherSystem'), category_slug='other-system')
...
def test_is_setting_encrypted(reg):
    reg.register('ASCENDER_SOME_SETTING_ENABLED', field_class=fields.CharField, category=_('System'), category_slug='system')
    reg.register('ASCENDER_SOME_ENCRYPTED_SETTING', field_class=fields.CharField, category=_('System'), category_slug='system', encrypted=True)
    assert reg.is_setting_encrypted('ASCENDER_SOME_SETTING_ENABLED') is False
    assert reg.is_setting_encrypted('ASCENDER_SOME_ENCRYPTED_SETTING') is True


def test_simple_field(reg):
    reg.register('ASCENDER_SOME_SETTING', field_class=fields.CharField, category=_('System'), category_slug='system', placeholder='Example Value')

    field = reg.get_setting_field('ASCENDER_SOME_SETTING')
...
def test_field_with_custom_attribute(reg):
    reg.register('ASCENDER_SOME_SETTING_ENABLED', field_class=fields.BooleanField, category_slug='system')

    field = reg.get_setting_field('ASCENDER_SOME_SETTING_ENABLED', category_slug='other-system')
...
def test_field_with_custom_mixin(reg):
    ...
    field = reg.get_setting_field('ASCENDER_SOME_SETTING_ENABLED', mixin_class=GreatMixin)
...
def test_default_value_from_settings(reg):
    reg.register('ASCENDER_SOME_SETTING', field_class=fields.CharField, category=_('System'), category_slug='system')
...
def test_default_value_from_settings_with_custom_representation(reg):
    ...
    reg.register('ASCENDER_SOME_SETTING', field_class=LowercaseCharField, category=_('System'), category_slug='system')
