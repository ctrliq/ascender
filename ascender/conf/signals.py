...
def disable_local_auth(**kwargs):
    if (kwargs['setting'], kwargs['value']) == ('DISABLE_LOCAL_AUTH', True):
        ...
        from ascender.main.models.oauth import OAuth2RefreshToken
        from ascender.main.models.oauth import OAuth2AccessToken
        from ascender.main.management.commands.revoke_oauth2_tokens import revoke_tokens
        ...
        revoke_tokens(OAuth2RefreshToken.objects.filter(revoked=None, user__in=qs))
