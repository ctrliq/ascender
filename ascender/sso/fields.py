...
from ascender.sso.ldap_group_types import PosixUIDGroupType  # noqa

# Ascender
from ascender.conf import fields
from ascender.main.validators import validate_certificate
from ascender.sso.validators import (  # noqa
    validate_ldap_dn,
...
def find_class_in_modules(class_name):
    ...
    """
    module_search_space = [django_auth_ldap.config, ascender.sso.ldap_group_types]
...
class AuthenticationBackendsField(fields.StringListField):
    ...
    REQUIRED_BACKEND_SETTINGS = collections.OrderedDict(
        [
            ('ascender.sso.backends.LDAPBackend', ['AUTH_LDAP_SERVER_URI']),
            ('ascender.sso.backends.LDAPBackend1', ['AUTH_LDAP_1_SERVER_URI']),
            ('ascender.sso.backends.LDAPBackend2', ['AUTH_LDAP_2_SERVER_URI']),
