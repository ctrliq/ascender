...
class ExecutionEnvironmentBuilderAccess(BaseAccess):
    ...
    def can_add(self, data):
        if not data:
            return Organization.accessible_objects(self.user, 'execution_environment_admin_role').exists()
        return self.check_related('organization', Organization, data, mandatory=True, role_field='execution_environment_admin_role') and self.check_related(
            'project', Project, data, role_field='use_role'
        )
    ...
    def can_change(self, obj, data):
        ...
        return self.check_related(
            'organization', Organization, data, obj=obj, mandatory=True, role_field='execution_environment_admin_role'
