...
EXPECTED_VALUES = {
    ...
    'awx_job_wait_seconds_average': 0.0,
    'awx_job_wait_seconds_longest': 0.0,
    'awx_job_run_seconds_average': 0.0,
    'awx_job_run_seconds_longest': 0.0,
    'awx_job_timing_sample_total': 0.0,
