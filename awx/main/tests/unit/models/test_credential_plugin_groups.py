...
from awx.main.models.credential import CREDENTIAL_PLUGIN_GROUPS, load_credential_plugins
...
def fake_entry_points(mocker):
    ...
    mocker.patch('awx.main.models.credential.entry_points', side_effect=_entry_points)
    return registry
...
def test_the_ascender_group_wins_a_name_collision(fake_entry_points):
    ...
    from awx.main.credential_plugins.conjur import conjur_plugin
