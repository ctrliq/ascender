...
def setup_event_partitioning(apps, schema_editor):
    ...
    with connection.cursor() as cursor:
        ...
        cursor.execute(f'CREATE TABLE {tblname} ' f'(LIKE tmp_{tblname} INCLUDING ALL) ' f'PARTITION BY RANGE(job_created);')
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default='',
                        help_text='Path to the ansible-builder execution environment definition file within the project',
                        max_length=1024,
                        verbose_name='Execution Environment File',
                    ),
                ),
                (
                    'admin_role',
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        default=None,
                        help_text='The project that contains the execution environment definition file',
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name='%(class)ss',
                        to='main.project',
