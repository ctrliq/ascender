...
from awx.main.models import Credential, OAuth2RefreshToken, Role, Team
...
from awx.api.serializers.oauth2 import (
...
class UserSerializer(BaseSerializer):
    ...
    def validate_preferred_language(self, value):
        from awx.api.serializers.base import SUPPORTED_UI_LOCALES
