...
from awx.main.models.rbac import role_summary_fields_generator
from awx.main.fields import ImplicitRoleField
from awx.main.utils import get_model_for_type, camelcase_to_underscore, parse_yaml_or_json, encrypt_dict, prefetch_page_capabilities
...
class UnifiedJobTemplateSerializer(BaseSerializer):
    ...
    def get_sub_serializer(self, obj):
        from awx.api.serializers.inventory import InventorySourceSerializer
        from awx.api.serializers.job import JobTemplateSerializer
        from awx.api.serializers.project import ProjectSerializer
        from awx.api.serializers.system_job import SystemJobTemplateSerializer
        from awx.api.serializers.workflow import WorkflowApprovalTemplateSerializer, WorkflowJobTemplateSerializer
...
class UnifiedJobSerializer(BaseSerializer):
    ...
    def get_sub_serializer(self, obj):
        from awx.api.serializers.ad_hoc_command import AdHocCommandSerializer
        from awx.api.serializers.inventory import InventoryUpdateSerializer
        from awx.api.serializers.job import JobSerializer
        from awx.api.serializers.project import ProjectUpdateSerializer
        from awx.api.serializers.system_job import SystemJobSerializer
        from awx.api.serializers.workflow import WorkflowApprovalSerializer, WorkflowJobSerializer
...
class UnifiedJobListSerializer(UnifiedJobSerializer):
    ...
    def get_sub_serializer(self, obj):
        from awx.api.serializers.ad_hoc_command import AdHocCommandListSerializer
        from awx.api.serializers.inventory import InventoryUpdateListSerializer
        from awx.api.serializers.job import JobListSerializer
        from awx.api.serializers.project import ProjectUpdateListSerializer
        from awx.api.serializers.system_job import SystemJobListSerializer
        from awx.api.serializers.workflow import WorkflowApprovalListSerializer, WorkflowJobListSerializer
