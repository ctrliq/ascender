...
from awx.main.models import Group, Host, HostMetric, HostMetricSummaryMonthly, JobHostSummary
from awx.main.utils import parse_yaml_or_json, has_model_field_prefetched
...
class HostSerializer(BaseSerializerWithVariables):
    ...
    def get_summary_fields(self, obj):
        from awx.api.serializers.base import DEFAULT_SUMMARY_FIELDS
