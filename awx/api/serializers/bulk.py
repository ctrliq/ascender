...
from awx.main.utils import parse_yaml_or_json, get_licenser
from awx.main.signals import update_inventory_computed_fields
from awx.api.versioning import reverse
from awx.api.serializers.host import (
    HostSerializer,
)
from awx.api.serializers.workflow import (
...
class BulkJobNodeSerializer(WorkflowJobNodeSerializer):
    ...
    def validate(self, attrs):
        from awx.api.serializers.base import LaunchConfigurationBaseSerializer
...
class BulkJobLaunchSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        from awx.api.serializers.workflow import WorkflowJobSerializer
