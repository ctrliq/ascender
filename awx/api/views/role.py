...
Lifted out of awx/api/views/__init__.py, which had grown to 1,407 lines and
...
from awx.api.generics import ListAPIView, RetrieveAPIView, SubListAPIView, SubListAttachDetachAPIView
