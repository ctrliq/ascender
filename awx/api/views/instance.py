...
Lifted out of awx/api/views/__init__.py, which had grown to 1,620 lines and
...
from awx.api.views.mixin import InstanceGroupMembershipMixin, RelatedJobsPreventDeleteMixin
