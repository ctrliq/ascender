...
from awx.main.utils import (
    ...
    getattrd,
    get_pk_from_dict,
    ScheduleWorkflowManager as ScheduleWorkflowManager,
...
from awx.api.permissions import (
    ...
    WorkflowApprovalPermission as WorkflowApprovalPermission,
...
from awx.main.scheduler.dag_workflow import WorkflowDAG as WorkflowDAG
...
def api_exception_handler(exc, context):
    ...
    if isinstance(exc, APIException):
        ...
        if 'awx.named_url_rewritten' in req.META and not str(getattr(exc, 'status_code', 0)).startswith('2'):
            ...
            req.path = req.META['awx.named_url_rewritten']
