...
export interface RelatedLookupTypeInputProps {
  /** The lookup currently chosen, null until the user picks one. */
  value: string | null;
  setValue: (value: string | null) => void;
  /** A css length, which is what the select's menu is capped at. */
