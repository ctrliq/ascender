...
describe('<HostForm />', () => {
  ...
  test('changing inputs should update form values', async () => {
    ...
    await user.clear(nameInput as unknown as Element);
    await user.type(nameInput as unknown as Element, 'new foo');
    await user.clear(descriptionInput as unknown as Element);
    await user.type(descriptionInput as unknown as Element, 'new bar');
