...
describe('<AddResourceRole />', () => {
  ...
  test('should save properly', async () => {
    ...
    await user.click(
      within(fooRow as unknown as HTMLElement).getByRole('checkbox')
    );
    await user.click(
      within(barRow as unknown as HTMLElement).getByRole('checkbox')
    );
    await user.click(
      within(bazRow as unknown as HTMLElement).getByRole('checkbox')
    );
    await user.click(
      within(bazRow as unknown as HTMLElement).getByRole('checkbox')
    );
  ...
  test('should reset values with resource type changes', async () => {
    ...
    await user.click(
      within(teamRow as unknown as HTMLElement).getByRole('checkbox')
    );
    await user.click(getPrimaryButton());
