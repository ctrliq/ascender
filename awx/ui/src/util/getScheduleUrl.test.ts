...
describe('getScheduleUrl', () => {
  test('should return expected schedule URL for inventory update job', () => {
    ...
    expect(getScheduleUrl(invSrcJob as unknown as Job | UnifiedJob)).toEqual(
  ...
  test('should return expected schedule URL for job', () => {
    ...
    expect(getScheduleUrl(templateJob as unknown as Job | UnifiedJob)).toEqual(
  ...
  test('should return expected schedule URL for project update job', () => {
    ...
    expect(
      getScheduleUrl(projectUpdateJob as unknown as Job | UnifiedJob)
    ).toEqual('/projects/6/schedules/7/details');
  });
  ...
  test('should return expected schedule URL for workflow job', () => {
    ...
    expect(getScheduleUrl(workflowJob as unknown as Job | UnifiedJob)).toEqual(
