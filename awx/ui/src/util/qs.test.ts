...
describe('qs (qs.js)', () => {
  describe('encodeQueryString', () => {
    test('encodeQueryString returns the expected queryString', () => {
      [
        ...
        const actualQueryString = encodeQueryString(
          params as unknown as QSParams | null | undefined
        );
  ...
  describe('getQSConfig', () => {
    ...
    test('should throw if no namespace given', () => {
      expect(() => getQSConfig(undefined as unknown as string)).toThrow();
    });
  ...
  describe('parseQueryString', () => {
    test('should get query params', () => {
      ...
      expect(parseQueryString(config as unknown as QSConfig, query)).toEqual({
        baz: 'bar',
        page: 3,
        page_size: 15,
      });
  ...
  describe('removeParams', () => {
    test('should remove query params', () => {
      ...
      expect(
        removeParams(config as unknown as QSConfig, oldParams, toRemove)
      ).toEqual({
        baz: 'bar',
        page: 3,
        page_size: 15,
  ...
  describe('_stringToObject', () => {
    test('should convert to object', () => {
      ...
      expect(
        _stringToObject(
          config as unknown as QSConfig,
          '?unit.foo=bar&unit.baz=bam'
        )
      ).toEqual({
        foo: 'bar',
        baz: 'bam',
    ...
    test('should omit keys from other namespaces', () => {
      ...
      expect(
        _stringToObject(
          config as unknown as QSConfig,
          '?unit.foo=bar&other.bar=bam&one=two'
        )
      ).toEqual({
        foo: 'bar',
      });
    ...
    test('should convert numbers to correct type', () => {
      ...
      expect(
        _stringToObject(config as unknown as QSConfig, '?unit.page=3')
      ).toEqual({
        page: 3,
      });
    });
  ...
  describe('_addDefaultsToObject', () => {
    test('should add missing default values', () => {
      ...
      expect(_addDefaultsToObject(config as unknown as QSConfig, {})).toEqual({
        page: 1,
        page_size: 5,
        order_by: 'name',
      });
    ...
    test('should not override existing params', () => {
      ...
      expect(
        _addDefaultsToObject(config as unknown as QSConfig, params)
      ).toEqual({
        page: 2,
        page_size: 5,
        order_by: 'date_created',
    ...
    test('should handle missing defaultParams', () => {
      ...
      expect(_addDefaultsToObject({} as unknown as QSConfig, params)).toEqual({
        page: 2,
        order_by: 'date_created',
      });
    });
  ...
  describe('updateQueryString', () => {
    ...
    test('should add param to empty query string', () => {
      ...
      expect(
        updateQueryString(config as unknown as QSConfig, '', newParams)
      ).toEqual('template.page=3');
    });
    ...
    test('should update namespaced param', () => {
      ...
      expect(
        updateQueryString(config as unknown as QSConfig, query, newParams)
      ).toEqual('template.name__icontains=workflow&template.page=3');
    });
    ...
    test('should maintain non-namespaced param', () => {
      ...
      expect(
        updateQueryString(config as unknown as QSConfig, query, newParams)
      ).toEqual('foo=bar&template.name__icontains=workflow&template.page=3');
    });
