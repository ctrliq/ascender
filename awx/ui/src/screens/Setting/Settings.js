...
function Settings() {
  ...
  const breadcrumbConfig = {
    ...
    '/settings/oidc': i18n._(t`Generic OIDC`),
    '/settings/oidc/details': i18n._(t`Details`),
    '/settings/oidc/edit': i18n._(t`Edit Details`),
    ...
    '/settings/miscellaneous_authentication': i18n._(
      t`Miscellaneous Authentication`
    ),
    '/settings/miscellaneous_authentication/details': i18n._(t`Details`),
    '/settings/miscellaneous_authentication/edit': i18n._(t`Edit Details`),
    ...
    '/settings/troubleshooting': i18n._(t`Troubleshooting`),
    '/settings/troubleshooting/details': i18n._(t`Details`),
    '/settings/troubleshooting/edit': i18n._(t`Edit Details`),
  };
