...
function OrganizationDetail({ organization }: OrganizationDetailProps) {
    ...
    <CardBody>
      <DetailList>
        ...
        <ExecutionEnvironmentDetail
          ...
          helpText={t`The execution environment that will be used for jobs inside of this organization. This will be used as a fallback when an execution environment has not been explicitly assigned at the project, job template or workflow level.`}
        />
        <UserDateDetail
          label={t`Created`}
          date={created}
