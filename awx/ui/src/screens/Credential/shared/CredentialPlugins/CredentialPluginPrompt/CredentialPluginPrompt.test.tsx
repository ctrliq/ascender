...
describe('<CredentialPluginPrompt />', () => {
  beforeEach(() => {
    vi.mocked(CredentialsAPI.test).mockResolvedValue(
      {} as unknown as ResponseOf<typeof CredentialsAPI.test>
    );
    vi.mocked(CredentialsAPI.read).mockResolvedValue(
      mockCredentialResults as unknown as ApiResponse<unknown>
    );
    vi.mocked(CredentialsAPI.readOptions).mockResolvedValue(
      mockCredentialOptions as unknown as ApiResponse<unknown>
    );
    vi.mocked(CredentialTypesAPI.readDetail).mockResolvedValue(
      mockCredentialTypeDetail as unknown as ApiResponse<unknown>
    );
  });
