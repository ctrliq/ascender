...
function WorkflowJobTemplatesList({
  ...
  const {
    ...
    ['workflow-job-templates-list', location.search],
    useCallback(async () => {
      const params = parseQueryString(QS_CONFIG, location.search);
      const [response, actionsResponse] = await Promise.all([
        // role_level belongs in the query string; passed as a second
        // argument it reached nothing and the list was unfiltered.
        WorkflowJobTemplatesAPI.read({ ...params, role_level: 'execute_role' }),
