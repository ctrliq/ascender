...
function getHelpText(i18n) {
  return {
    ...
    description: i18n._(
      msg`Optional description for the workflow job template.`
    ),
    inventory: i18n._(
      msg`Select the inventory containing the hosts you want this workflow to manage.`
    ),
    organization: i18n._(
      msg`The organization that owns this workflow job template.`
    ),
    extra_vars: i18n._(msg`Pass extra command line variables to the workflow.`),
    limit: i18n._(
      msg`Provide a host pattern to further constrain the list of hosts that will be managed or affected by the workflow.`
    ),
    scm_branch: i18n._(msg`Select a branch for the workflow.`),
    survey_enabled: i18n._(
      msg`Enable a survey for this workflow job template.`
    ),
    allow_simultaneous: i18n._(
      msg`Allow simultaneous runs of this workflow job template.`
    ),
    ...
    ask_execution_environment_on_launch: i18n._(
      msg`Prompt for execution environment on launch.`
    ),
    ask_instance_groups_on_launch: i18n._(
      msg`Prompt for instance groups on launch.`
    ),
    ask_job_slice_count_on_launch: i18n._(
      msg`Prompt for job slice count on launch.`
    ),
    ...
    webhook_service: i18n._(
      msg`Webhook service for this workflow job template.`
    ),
    ...
    webhook_credential: i18n._(
      msg`Webhook credential for this workflow job template.`
    ),
  };
}
