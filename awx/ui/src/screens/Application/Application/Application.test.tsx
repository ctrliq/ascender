...
describe('<Application />', () => {
  beforeEach(() => {
    ...
    vi.mocked(ApplicationsAPI.readDetail).mockResolvedValue({
      data: application,
    } as unknown as ResponseOf<typeof ApplicationsAPI.readDetail>);
  });
  ...
  test('shows a not-found error when the detail request 404s', async () => {
    ...
    vi.mocked(ApplicationsAPI.readDetail).mockRejectedValue(err);
    renderAt('/applications/1/details');
    expect(
