...
function InstanceFormFields({ isEdit }: InstanceFormFieldsProps) {
  const { t } = useLingui();
  ...
  return (
    <>
      ...
      <FormGroup
        ...
        labelHelp={
          <Popover
            content={t`Sets the role that this instance will play within mesh topology. Default is "execution."`}
          />
        }
        isRequired
      >
