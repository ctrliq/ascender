      ...
      {isModalOpen && (
        <AlertModal
          ...
          title={
            <Plural
              value={groups.length}
              one={i18n._(t`Delete Group?`)}
              other={i18n._(t`Delete Groups?`)}
            />
          }
        ...
        >
          <Plural
            value={groups.length}
            one={i18n._(t`Are you sure you want delete the group below?`)}
            other={i18n._(t`Are you sure you want delete the groups below?`)}
          />
