import type { Inventory, DetailedError, Untyped } from 'types/api';
...
function InventoryHost({ setBreadcrumb, inventory }: InventoryHostProps) {
  const { t } = useLingui();
    ...
    return (
      <Card>
        <ContentError error={contentError}>
          {(contentError as DetailedError).response &&
