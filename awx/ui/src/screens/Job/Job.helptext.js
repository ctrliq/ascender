...
const jobHelpText = (i18n) => ({
  ...
  project: i18n._(
    'The project containing the playbook this job will execute.'
  ),
  project_source: i18n._(
    'The project from which this inventory update is sourced.'
  ),
  ...
  playbook: i18n._('Select the playbook to be executed by this job.'),
  credentials: i18n._(
  ...
  projectUpdate: i18n._('Project checkout results'),
  forks: (
    <span>
      {i18n._(
  ...
  module: (moduleName) =>
    moduleName ? (
      <>
        {i18n._(
          `These arguments are used with the specified module. You can find information about ${moduleName} by clicking `
        )}{' '}
        <a
      ...
      i18n._('These arguments are used with the specified module.')
    ),
});
