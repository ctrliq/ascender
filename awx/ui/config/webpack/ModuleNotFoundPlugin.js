...
// Rewrites webpack's "Module not found" and CaseSensitivePathsPlugin errors
// into shorter messages that name the importing file.
      ...
      if (isModule) {
        details = [
          ...
          'You can install this package by running: ' +
            colors.bold(`npm install ${target}`) +
            '.',
        ];
      } else if (isFile) {
